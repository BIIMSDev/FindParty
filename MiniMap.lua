...
FP_Minimap_ButtonIcon:SetWidth(60)
FP_Minimap_ButtonIcon:SetHeight(60)
FP_Minimap_ButtonIcon:SetPoint("CENTER", 0, 0)
...
FP_Minimap_ButtonBorder:SetWidth(62)
FP_Minimap_ButtonBorder:SetHeight(62)
